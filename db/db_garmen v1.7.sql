...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2020 at 03:46 AM
...
(1, '', 'Kain Spandek Licra', 'bandung', '2020-06-23');
...
INSERT INTO `pelanggan` (`id`, `kode_pelanggan`, `id_pemesanan`, `alamat`, `date_created`) VALUES
(5, 1, 8, 'bandung', '2020-06-23 11:58:06'),
(6, 2, 9, 'jakarta', '2020-06-23 13:24:39');
...
--
-- Table structure for table `permintaan_belanja`
--
...
--
-- Dumping data for table `permintaan_belanja`
--
...
--
ALTER TABLE `pelanggan`
  ADD CONSTRAINT `pelanggan_ibfk_1` FOREIGN KEY (`id_pemesanan`) REFERENCES `pemesanan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `permintaan_belanja`
--
ALTER TABLE `permintaan_belanja`

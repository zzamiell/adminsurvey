...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2020 at 09:10 AM
...
--
-- Dumping data for table `detail_penesanan`
--

INSERT INTO `detail_penesanan` (`id`, `id_pemesanan`, `id_produk`, `jumlah`, `total`) VALUES
(5, 4, 1, 5, 150000);
...
INSERT INTO `pemesanan` (`id`, `nama`, `total_bayar`, `tipe`, `tanggal_pemesanan`) VALUES
(4, 'ASF', 150000, 'pembeli', '2020-06-07 07:08:35');
...
ALTER TABLE `detail_penesanan`
  ...
  ADD CONSTRAINT `detail_penesanan_ibfk_2` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
